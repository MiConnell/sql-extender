...
from sql_extender import __version__
from sql_extender.example import hello
...
app = typer.Typer(
    name="sql-extender",
    help="Python package to extend sql functionality",
...
def version_callback(value: bool):
    ...
    if value:
        console.print(
            f"[yellow]sql-extender[/] version: [bold blue]{__version__}[/]"
        )
        raise typer.Exit()
...
def main(
    ...
    version: bool = typer.Option(
        ...
        is_eager=True,
        help="Prints the version of the sql-extender package.",
    ),
):
